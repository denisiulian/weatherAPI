...
let weatherAPIKey = 'cc044cfc83e6ca18be2a53788894d0fa';
...
let init = () => {
    weatherForCity('Cluj-Napoca').then(() => document.body.style.filter = 'blur(0');
}
...
let updateCurrentWeather = (data) => {
    ...
    let direction = findDirection(deg);
    wind.textContent = direction + ', ' + data.wind.speed;
